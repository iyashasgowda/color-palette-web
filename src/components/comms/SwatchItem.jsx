        ...
        >
            ...
            <div className='swatch-hex'>
                ...
                <img
                    ...
                    alt='copy'
                    onClick={() => copyText(rgb2hex(props.rgb[0], props.rgb[1], props.rgb[2])).then(() => makeToast(`${rgb2hex(props.rgb[0], props.rgb[1], props.rgb[2])} copied.`))}
                />
            </div>
            <div className='swatch-rgb'>
                ...
                <img
                    ...
                    src={getCopyIcon(props.rgb)}
                    alt='copy'
                    onClick={() => copyText(`${props.rgb[0]}, ${props.rgb[1]}, ${props.rgb[2]}`).then(() => makeToast(`${props.rgb[0]}, ${props.rgb[1]}, ${props.rgb[2]} copied.`))}
                />
            </div>
        </div>
    );
...
export default memo(SwatchItem);
