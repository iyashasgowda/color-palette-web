...
const Solid = (props) => {
    ...
    return (
        <div className='solid-section'>
            {modal.hex ? (
                <Modal darkMode={props.darkMode} is_hex={true} is_alpha={checkbox} from={'solid'}
                       closeModal={handleModalClose} inputColor={handleColorInput}/>
            ) : modal.rgba ? (
                <Modal darkMode={props.darkMode} is_hex={false} is_alpha={checkbox} from={'solid'}
                       closeModal={handleModalClose} inputColor={handleColorInput}/>
            ) : (
                <></>
            )}
            ...
            <div className='solid-header'>
                ...
                <div className='solid-alpha-control'>
                    <p>Alpha</p>
                    <input type='checkbox' className='toggle-checkbox' id='solid-alpha-checkbox' checked={checkbox}
                           onChange={() => props.changeSolid({...props.solid, checkbox: !checkbox})}/>
                </div>
            </div>
                ...
                <div className='solid-control'>
                    <div className='solid-attributes'>
                        <div className='solid-hex'>
                            ...
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/icons/edit.svg`} alt='edit'
                                     onClick={() => setModal({...modal, hex: true})}/>
                                <img
                        ...
                        <div className='solid-rgb'>
                            ...
                            <div>
                                <img src={`${process.env.PUBLIC_URL}/assets/icons/edit.svg`} alt='edit'
                                     onClick={() => setModal({...modal, rgba: true})}/>
                                <img
                                    src={`${process.env.PUBLIC_URL}/assets/icons/copy.svg`}
                                    alt='copy'
