...
const Gradient = (props) => {
    ...
    return (
        <div className='gradient-section'>
            {modal.hex ? (
                <Modal darkMode={props.darkMode} is_hex={true} is_alpha={checkbox} closeModal={handleModalClose}
                       inputColor={handleColorInput}/>
            ) : modal.rgba ? (
                <Modal darkMode={props.darkMode} is_hex={false} is_alpha={checkbox} closeModal={handleModalClose}
                       inputColor={handleColorInput}/>
            ) : (
                <></>
            )}
            ...
            <div className='gradient-header'>
                ...
                <div className='gradient-alpha-control'>
                    ...
                    <input
                        ...
                        checked={checkbox}
                        onChange={() => {
                            props.changeGradient({...props.gradient, checkbox: !checkbox});
                        }}
                    />
                </div>
            </div>
