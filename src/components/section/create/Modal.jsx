         ...
         <div className='modal-container'>
            <div className='modal-content'>
               <div className='modal-header'>
                  ...
                  <img src={close_icon} alt='close' onClick={() => props.closeModal()} />
               </div>
               ...
               <div className='modal-body'>
                  ...
                  <input type='text' name='color_code' id='color_code' placeholder={props.is_hex ? (props.is_alpha ? '#RRGGBBAA' : '#RRGGBB') : props.is_alpha ? 'R, G, B, A' : 'R, G, B'} />
               </div>
            </div>
