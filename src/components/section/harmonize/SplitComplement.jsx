        ...
        <div className='split-container'>
            ...
            <div className='split-body'>
                <div className='colors-container'>
                    ...
                    <p className='info'>
                        <b>Split complementary:</b> Primary color with two analogous colors in the color wheel. This
                        combination has strong contrast as the complementary color.
                    </p>
                ...
                <div className='color-wheel'>
                    <canvas className='split-canvas' onMouseMove={(e) => handleMouseMove(e)}
...
export default memo(SplitComplement);
