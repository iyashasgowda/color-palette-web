...
const Complement = (props) => {
    ...
    const complement_ico = props.darkMode ? `${process.env.PUBLIC_URL}/assets/icons/light/complement.svg` : `${process.env.PUBLIC_URL}/assets/icons/dark/complement.svg`
        ...
        <div className='complement-container'>
            <div className='complement-header'>
                <div className='complement-header-title'>
                    <img src={complement_ico} alt='complement_ico'/>
                    <p>Complement</p>
                </div>
            </div>
            ...
            <div className='complement-body'>
                <div className='colors-container'>
                    ...
                    <p className='info'>
                        <b>Complementary:</b> Two colors that are on opposite sides of the color wheel. This combination
                        has extremely high contrast and is termed as loud.
                    </p>
                ...
                <div className='color-wheel'>
                    <canvas className='complement-canvas' onMouseMove={(e) => handleMouseMove(e)}
...
export default memo(Complement);
