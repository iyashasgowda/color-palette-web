...
const Triadic = (props) => {
    ...
    const triadic_ico = props.darkMode ? `${process.env.PUBLIC_URL}/assets/icons/light/triadic.svg` : `${process.env.PUBLIC_URL}/assets/icons/dark/triadic.svg`;
        ...
        <div className='triadic-container'>
            <div className='triadic-header'>
                <div className='triadic-header-title'>
                    <img src={triadic_ico} alt='triadic_ico'/>
                    <p>Triadic</p>
                </div>
            </div>
            ...
            <div className='triadic-body'>
                <div className='colors-container'>
                    ...
                    <p className='info'>
                        <b>Triadic:</b> Three colors are equidistant from one another and evenly spaced on the color
                        wheel. This combination creates bold, vibrant color palettes.
                    </p>
                    ...
                    <div className='invert-mode'>
                        ...
                        <div
                            ...
                            <img src={save_btn} alt='save'/>
                        </div>
                    </div>
                </div>

                <div className='color-wheel'>
                    <canvas className='triadic-canvas' onMouseMove={(e) => handleMouseMove(e)}
