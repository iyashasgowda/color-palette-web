...
const Tetradic = (props) => {
    ...
    const tetradic_ico = props.darkMode ? `${process.env.PUBLIC_URL}/assets/icons/light/tetradic.svg` : `${process.env.PUBLIC_URL}/assets/icons/dark/tetradic.svg`;
        ...
        <div className='tetradic-container'>
            <div className='tetradic-header'>
                <div className='tetradic-header-title'>
                    <img src={tetradic_ico} alt='tetradic_ico'/>
                    <p>Tetradic</p>
                </div>
            </div>
            ...
            <div className='tetradic-body'>
                <div className='colors-container'>
                    ...
                    <div className='codes'>
                        ...
                        <div className='code'>
                            <p onClick={() => copyText(d_hex).then(() => makeToast(`${d_hex} copied :)`))}>
                                {d_hex}
                            </p>
                            <p onClick={() => copyText(`${d_rgb.r}, ${d_rgb.g}, ${d_rgb.b}`).then(() => makeToast(`${d_rgb.r}, ${d_rgb.g}, ${d_rgb.b} copied :)`))}>
                                {`${d_rgb.r}, ${d_rgb.g}, ${d_rgb.b}`}
                            </p>
                        </div>
                    </div>
                    ...
                    <p className='info'>
                        <b>Tetradic:</b> Four colors are evenly spaced on the color wheel. Works best if you let one
                        color be dominant and others as accents.
                    </p>
                ...
                <div className='color-wheel'>
                    <canvas className='tetradic-canvas' onMouseMove={(e) => handleMouseMove(e)}
                            onMouseDown={(e) => handleMouseDown(e)} onMouseUp={(e) => handleMouseUp(e)}
