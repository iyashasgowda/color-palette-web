...
const Extraction = (props) => {
    ...
    return (
        <div className='extraction-container'>
            {modal.swatch.active ? (
                <ExtractModal darkMode={props.darkMode} swatch={true} data={swatch[modal.swatch.index]}
                              closeModal={closeModal} reloadExtract={reloadSwatch}/>
            ) : modal.palette.active ? (
                <ExtractModal darkMode={props.darkMode} swatch={false} data={palette[modal.palette.index]}
                              closeModal={closeModal} reloadExtract={reloadPalette}/>
            ) : (
                <></>
            )}
            ...
            <div className='extraction-header'>
                ...
                <div className='extraction-options'>
                    <select className='options' defaultValue={props.extraction}
                            onChange={(e) => props.changeExtraction(parseInt(e.target.value))}>
