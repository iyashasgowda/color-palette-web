...
const Harmony = (props) => {
    const harmony_ico = props.darkMode ? `${process.env.PUBLIC_URL}/assets/icons/light/harmony.svg` : `${process.env.PUBLIC_URL}/assets/icons/dark/harmony.svg`;
        ...
        if (props.harmony === 1) {
            ...
            if (complement === null) list = loading;
                ...
                list = (
                    <div className='data-items'>
                        {complement.map((item) => (
                            <Dual key={item.key} type='complement' name='Complement' data={item} shouldSave={false}
                                  removeItem={changeComplement}></Dual>
                        ))}
                    </div>
                );
            ...
            if (split === null) list = loading;
                ...
                list = (
                    <div className='data-items'>
                        {split.map((item) => (
                            <Trial key={item.key} type='split' name='Split Complement' data={item} shouldSave={false}
                                   removeItem={changeSplit}></Trial>
                        ))}
                    </div>
                );
            ...
            if (analogous === null) list = loading;
                ...
                list = (
                    <div className='data-items'>
                        {analogous.map((item) => (
                            <Trial key={item.key} type='analogous' name='Analogous' data={item} shouldSave={false}
                                   removeItem={changeAnalogous}></Trial>
                        ))}
                    </div>
                );
            ...
            if (triadic === null) list = loading;
                ...
                list = (
                    <div className='data-items'>
                        {triadic.map((item) => (
                            <Trial key={item.key} type='triadic' name='Triadic' data={item} shouldSave={false}
                                   removeItem={changeTriadic}></Trial>
                        ))}
                    </div>
                );
            ...
            if (tetradic === null) list = loading;
                ...
                list = (
                    <div className='data-items'>
                        {tetradic.map((item) => (
                            <Quadral key={item.key} type='tetradic' name='Tetradic' data={item} shouldSave={false}
                                     shouldRemove={true} removeItem={changeTetradic}></Quadral>
                        ))}
                    </div>
                );
        }
        ...
        <div className='harmony-container'>
            <div className='harmony-header'>
                <div className='harmony-header-title'>
                    <img src={harmony_ico} alt='harmony_ico'></img>
                    <p>{title}</p>
                </div>

                <div className='harmony-options'>
                    <select className='options' defaultValue={props.harmony}
                            onChange={(e) => props.changeHarmony(parseInt(e.target.value))}>
