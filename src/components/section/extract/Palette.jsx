      ...
      <div className='palette-section'>
         ...
         <div className='palette-header'>
            <div className='palette-header-title'>
               <img src={palette_icon} alt='palette_icon' />
               <p>Extract palette</p>
            </div>
         ...
         <div className='palette-body'>
            <div className='palette-img-chooser' onClick={() => document.querySelector('#palette-file-input').click()}>
               <input id='palette-file-input' style={{ display: 'none' }} type='file' accept='image/*' onChange={(e) => changePalette(e)} onClick={(e) => resetPalette(e)} />
               {!is_active && (
            ...
            <div className='extracted-palette'>
               {props.palette.palette.swatches !== undefined ? (
                  props.palette.palette.swatches.map((item, index) => (
                     <Item
                        key={index}
                        data={{
                           rgb: item.getRGB(),
