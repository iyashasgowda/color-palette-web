...
const Section = (props) => {
   ...
   const handleSwatchChange = (e) => {
      if (e.target.files && e.target.files[0]) {
         ...
         reader.onload = (e) => getSwatches(e.target.result, (swatches) => setSwatch({ path: e.target.result, swatches }));
   ...
   return (
      <section>
         ...
         {props.activeMenu === 3 && <Extract darkMode={props.darkMode} swatch={swatch} changeSwatch={handleSwatchChange} />}
